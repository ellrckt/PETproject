...
## DO
### !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
### В записке в проектировании убрать messagebrokers и поменять схему работы системы.! пункт 2.6, 2.8
### !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
8 интерфейс на русском
9 непрочитанные, за промежуток времени; встречи, задачи, общее резюме истории
