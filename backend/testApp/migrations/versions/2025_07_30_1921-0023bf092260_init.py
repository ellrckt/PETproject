...
Revision ID: 0023bf092260
Revises:
Create Date: 2025-07-30 19:21:56.121711
...
#     op.drop_index(
#         op.f("idx_tiger_featnames_tlid_statefp"), table_name="featnames"
#     )
...
#         ),
#         sa.Column(
#             "the_geom", sa.NullType(), autoincrement=False, nullable=True
#         ),
#         sa.CheckConstraint(
...
#         ),
#         sa.CheckConstraint(
#             "st_ndims(the_geom) = 2", name=op.f("enforce_dims_the_geom")
#         ),
#         sa.CheckConstraint(
#             "st_srid(the_geom) = 4269", name=op.f("enforce_srid_the_geom")
#         ),
#         sa.PrimaryKeyConstraint("gid", name=op.f("addrfeat_pkey")),
#     )
#     op.create_index(
#         op.f("idx_addrfeat_zipr"), "addrfeat", ["zipr"], unique=False
#     )
#     op.create_index(
#         op.f("idx_addrfeat_zipl"), "addrfeat", ["zipl"], unique=False
#     )
#     op.create_index(
#         op.f("idx_addrfeat_tlid"), "addrfeat", ["tlid"], unique=False
#     )
#     op.create_index(
#         op.f("idx_addrfeat_geom_gist"),
#         "addrfeat",
...
#     )
#     op.create_index(
#         op.f("idx_tiger_faces_tfid"), "faces", ["tfid"], unique=False
#     )
#     op.create_index(
...
#         ),
#         sa.CheckConstraint(
#             "st_ndims(the_geom) = 2", name=op.f("enforce_dims_geom")
#         ),
#         sa.CheckConstraint(
#             "st_srid(the_geom) = 4269", name=op.f("enforce_srid_geom")
#         ),
...
#             "st_code", "co_code", name=op.f("county_lookup_pkey")
#         ),
#     )
#     op.create_index(
#         op.f("county_lookup_state_idx"),
#         "county_lookup",
#         ["state"],
#         unique=False,
#     )
...
#             ["topology_id"],
#             ["topology.id"],
#             name=op.f("layer_topology_id_fkey"),
#         ),
#         sa.PrimaryKeyConstraint(
...
#     op.create_index(
#         op.f("idx_tiger_addr_tlid_statefp"),
#         "addr",
#         ["tlid", "statefp"],
#         unique=False,
#     )
...
#         sa.Column("short_desc", sa.TEXT(), autoincrement=False, nullable=True),
#         sa.PrimaryKeyConstraint(
#             "name", name=op.f("geocode_settings_default_pkey")
#         ),
#     )
#     op.create_table(
#         "pagc_lex",
...
#         ),
#         sa.PrimaryKeyConstraint(
#             "zcta5ce", "statefp", name=op.f("pk_tiger_zcta5_zcta5ce")
#         ),
#         sa.UniqueConstraint(
#             "gid",
